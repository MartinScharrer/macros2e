...
\begin{tabularx}{\linewidth}{lX}
   ...
   \Macro\@star@or@long & Tests for a following `|*|', if found \Macro\l@ngrel@x will be let to
   \Macro\relax, but \Macro\long otherwise. It can the be used before \Macro\def as an potential prefix.\\
   \Macro\@testopt{<1>}{<2>}  &  Short for \Macro\@ifnextchar'['{<1>}{<1>[{<2>}]}, i.e.\ \meta{2} will be used as default argument if non was given. \\

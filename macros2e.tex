...
\begin{tabularx}{\linewidth}{llX}
  ...
  \midrule
   ...
   \Macro\@backslashchar & ``\texttt{\@backslashchar}'' & Backslash with catcode 12, i.e. simple ASCII backlash usable in e.g.\ \Macro\write.\\
   \Macro\@percentchar   & ``\texttt{\@percentchar}'' & Percent character with catcode 12, i.e. simple ASCII percent usable in e.g.\ \Macro\write.\\
   \Macro\@clsexternsion & ``\texttt{cls}'' \\
   \Macro\@pkgexternsion & ``\texttt{sty}'' \\
  \bottomrule
\end{tabularx}

\subsection{Token Constants}
The following macros are defined using \Macro\let<\textbackslash macro>'='<token> and therefore equal to this token. They are useful for |\ifx| comparisons
...
\begin{tabularx}{\linewidth}{lX}
   ...
   Macro & Description \\
   \midrule
   \Macro\@namedef{<name>}<parameter list>{<definition>} & Define macro \MacroArgs<\textbackslash name> \relax(using \Macro\def). \\
   \Macro\@nameuse{<name>}  &  Expands to \MacroArgs<\textbackslash name>. \\
   ...
   \Macro\@ifundefined{<name>}{<yes>}{<no>} & Tests if \MacroArgs<\textbackslash name> is defined (and not equal to \Macro\relax). \\
   \Macro\@ifdefineable<\textbackslash name>{<yes>} & Tests if \MacroArgs<\textbackslash name> is undefined, \MacroArgs<name> not `|relax|'

...
\begin{tabularx}{\linewidth}{llX}
  ...
  \midrule
    ...
    \Macro\@depth         & ``\texttt{depth}''           & Used for box size declarations (\Macro\hb@xt@).\\
    \Macro\@height        & ``\texttt{height}''          & Used for box size declarations.\\
    \Macro\@width         & ``\texttt{width}''           & Used for box size declarations.\\
    \Macro\@minus         & ``\texttt{minus}''           & Used for skip declarations.\\
    \Macro\@plus          & ``\texttt{plus}''            & Used for skip declarations.\\
  \bottomrule
\end{tabularx}
...
\begin{tabular}{ll}
  ...
  \Macro\color@begingroup & \Macro\begingroup \\
  \Macro\color@endgroup   & \Macro\endgroup \\
  \Macro\color@setgroup   & \Macro\begingroup\set@color \\
  \Macro\color@hbox       & \hbox\bgroup\color@begingroup \\
  \Macro\color@vbox       & \vbox\bgroup\color@begingroup \\
  \Macro\color@endbox     & \color@endgroup\egroup \\
\end{tabular}
...
\noindent
Used to provide a default unit for |dimen| or |skip| assignment. Usage: |\@defaultunits\dimen=#1pt\relax\@nnil|.
...
\Macro\@partlist
Holds the comma-separated list defined by \Macro\includeonly.
...
\Macro\@removeelement{<element>}{<list>}{<cs>}
